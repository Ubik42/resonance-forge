...
没有 MIDI 硬件时也可以演奏。“弓行轨”把鼠标动作直接变成弓奏：按下时咬弦，横向移动给出推弓/回弓和弓速，纵向压入给出弓压，松手进入收弓；旁边双轮保留为数值反馈与微调。试音键床提供 C3–C4 的十三根锤键，横向决定音高，纵向决定原始力度；“力度凸轮”再用软触、线性或重手曲线把输入映射成实际激励能量。截图顶部的“配方对照尺”把 A 参考和 B 本炉沿声材、构型、起振、演奏、弓感和弦床六个工位摊开，青色立柱只标出真正发生变化的部分。
