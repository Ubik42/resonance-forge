...
![Version](https://img.shields.io/badge/Version-0.14.0-D96B2B)
...
模态撞击体不是固定预设黑盒。第三张的“共振齿列”把每一个真实模态放在对数频率轴上：齿高表示响度权重，短尾表示衰减；点击任意一根齿即可调整并试听。
...
5. 使用模态撞击体时，在“共振齿列”中点击一根齿，调整齿位、齿重或余响；松手后试听真实模态变化，也可随时按材质重新排齿。
