...
![Version](https://img.shields.io/badge/Version-0.29.0-D96B2B)
...
14. 切换到“数字波导弦”，先在“起振手势架”依次试听指腹、拨片与锤击；再固定手势与拾音梭，只把橙色起振锤从琴桥侧拖向弦心，试听初始谐波如何变化。最后单独移动青色拾音梭，比较输出梳状频谱；每次只改变一项。
