...
![Version](https://img.shields.io/badge/Version-0.25.0-D96B2B)
...
13. 切换到“数字波导弦”，调节弦床中的回响长度、弦路阻尼和箱体耦合，再在弦路尺上把青色拾音梭从琴桥拖向弦心。先固定前三项，只移动拾音梭，最容易听清谐波缺口的变化；拖动过程只塑形，松手试听一次。
